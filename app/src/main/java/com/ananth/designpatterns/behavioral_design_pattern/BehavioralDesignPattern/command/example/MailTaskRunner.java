...
//Throw away POC code dont use ir in the PROD
//This is invoke actually executing the command
//Start a worker thread in charge of executing command.
public class MailTaskRunner implements Runnable {
    ...
    //run method takes pending command and execute it.
    @Override
    public void run() {
        while (true) {
            Command cmd = null;
